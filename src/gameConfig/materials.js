...
export class Material {
  constructor(
    ...
    this.animationData = materialRenderInstructions.find(
      (animation) => animation.materialId === initialMaterialId,
    )
  }
  ...
  get isDestroyed() {
    return this.hitCount >= this.maxHitCount
  }
  ...
  registerCollision = () => {
    ...
    if (this.isInteractable) {
      ...
      this.hitCount++
      if (this.hitCount < this.maxHitCount) return this.hitReward
      // return a hit reward
  ...
  [
    {
      ...
      animations: [
        ...
        },
        {
          type: animationTypes.DESTROY_ANIMATION,
          cycleTime: 1000,
          imageFrames: [BRICK_1, BRICK_2, BRICK_3, BRICK_4],
        },
      ],
    },
    {
      ...
      animations: [
        {
          type: animationTypes.BASE_ANIMATION,
          cycleTime: 1000,
          imageFrames: [WOOD_1, WOOD_2, WOOD_3],
        },
        {
          type: animationTypes.HIT_ANIMATION,
          cycleTime: 1000,
        ...
        },
        {
          type: animationTypes.DESTROY_ANIMATION,
          cycleTime: 1000,
          imageFrames: [WOOD_1, WOOD_2, WOOD_3, WOOD_4, WOOD_5],
        },
      ],
    },
    {
